                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group col-md-6">
                                <label>photo1</label>
                                <img src="{{ asset($image->photo1) }}" alt="" style="height: 50px">
                            </div>
                            <div class="form-group col-md-6">
                                <label>photo2</label>
                                <img src="{{ asset($image->photo2) }}" alt="" style="height: 50px">
                            </div>
                            <div class="form-group col-md-6">
                                <label>photo1</label>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input  type="text" name="text1" class="form-control"
                                    placeholder="" value="{{$image->text1}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label>text2</label>
                                <input  type="text" name="text2" class="form-control"
                                    placeholder="" value="{{$image->text2}}">
                            </div>
