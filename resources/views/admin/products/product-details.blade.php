...
@section('body')
    ...
    <div class="container-fluid">
        ...
        <div class="animated fadeIn">
            <form action="{{route('admin.productdetails.store')}}" method="post">
                @csrf
                @method('POST')
                <div class="row">
                    @if ($errors->any())
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                         <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                <label>color</label>
                                <input type="text" name="color" value="" class="form-control" placeholder="enter color"
                                   >
                             </div>
                            <div class="form-group col-md-12">
                                <label>size</label>
                                <input type="text" name="size" value="" class="form-control" placeholder="enter size"
                                   >
                             </div>
                             <div class="form-group col-md-12">
