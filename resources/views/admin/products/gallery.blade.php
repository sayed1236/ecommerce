...
@section('body')
    ...
    <div class="container-fluid">
        ...
        <div class="animated fadeIn">
            <form action="{{route('admin.storegallery.product')}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                    @if ($errors->any())
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group col-md-12">
                                <label>image</label>
                                <input type="file" name="gallery[]" class="form-control" placeholder="enter photo"
                                 multiple  >
                            </div>
